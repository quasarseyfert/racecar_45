...
class ColorTracker:
	...
	self.pub_blob_size = rospy.Publisher("/blob_size", Float32, queue_size=10)
	...
	#self.pub_image = rospy.Publisher("/blob_mask", Image, queue_size=1)
